...
const cancelSubscitionTemplate = (userName, userId, email, reason) => {
  return `<div style="width:100%;margin:0;padding:0;line-height:1.6">
          ...
          <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
            <tbody>
              ...
              <tr>
                <td align="center"
                  style="  padding-bottom: 10px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; ">
                  <h1> User from Regaapp request to cancel subscription</h1>
                  <h3
                    style="margin: 0; font-size: 24px; font-weight: 700; letter-spacing: -1px; color:#002054f2">
                      userName:
                    ${userName} </br></br>
                    UserId:${userId} </br></br>
                    userEmail:${email}</br></br>
                    is requesting  to delete information </h3>
                </td>
              </tr>
              <tr>
                <td align="center"
                  style="  padding-bottom: 10px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; ">
                  <h1> Reason from user</h1>
                  <p style="margin: 0; font-size: 14px; font-weight: 100; letter-spacing: -1px; color:#000">
                      ${reason}
                    </p>
                </td>
              </tr>
